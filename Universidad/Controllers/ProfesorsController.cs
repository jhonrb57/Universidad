...
namespace Universidad.Controllers
{
    public class ProfesorsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Apellido,Nombre,FechaContratacion")] Profesor profesor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Apellido,Nombre,FechaContratacion")] Profesor profesor)
        {
            if (ModelState.IsValid)
            {

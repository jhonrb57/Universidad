...
namespace Universidad.Controllers
{
    public class MateriasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MateriaID,Titulo,Creditos")] Materia materia)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MateriaID,Titulo,Creditos")] Materia materia)
        {
            if (ModelState.IsValid)
            {
